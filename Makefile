...
./src/automata/life.o: ./src/automata/life_like.h ./src/automata/life.cpp ./src/automata/life.h ./src/curses/screen.o ./src/curses/screen.h ./src/grid/grid.h ./src/grid/toroidal_grid.h
...
life.out: ./src/test/test_life.cpp ./src/automata/life.h ./src/automata/life_like.o ./src/automata/life.o ./src/curses/screen.o ./src/curses/screen.h
	$(CXX) $(CXXFLAGS) $(LDFLAGS) ./src/test/test_life.cpp ./src/curses/screen.o ./src/automata/life_like.o ./src/automata/life.o -o ./life.out
